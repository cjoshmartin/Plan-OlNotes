...
/**
 * Created by Josh on 11/24/15.
 */
public class NotesProvider extends ContentProvider{

    private static final String AUTHORITY = "com.cjoshmartin.plainolnotes.notesprovider";
    ...
    static {
        // only exacts the first time anything is called from this class
